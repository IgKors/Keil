...
typedef struct {
	...
	float 	 Period;        /*!< Period used, set on initialization for PWM */
	uint32_t Prescaler;     /*!< Prescaler used for PWM frequency */
	float 	 Frequency;  		/*!< PWM frequency used */
	
	float 	 Micros;        /*!< Microseconds used for one period.
                               This is not useful in large pwm frequency, 
																but good for controlling servos or similar,
                               Where you need exact time of pulse high */
	
	float CH_Periods[4]; 		/*!< Array of periods for PWM compare */
 ...
 */
TM_PWM_Result_t TM_PWM_InitTimer(TIM_TypeDef* TIMx, TM_PWM_TIM_t* TIM_Data, float PWMFrequency);
 ...
 * @retval Member of @ref TM_PWM_Result_t
 */
TM_PWM_Result_t TM_PWM_SetChannel(TM_PWM_TIM_t* TIM_Data, TM_PWM_Channel_t Channel, float Pulse);
 ...
 * @retval Member of @ref TM_PWM_Result_t
 */
TM_PWM_Result_t TM_PWM_SetChannelMicros(TM_PWM_TIM_t* TIM_Data, TM_PWM_Channel_t Channel, float micros);
