 ...
 */
typedef struct {
	float TimerFrequency; 	 /*!< timer's working frequency */
	float MaxPeriod;      /*!< Max timer period */
	uint32_t MaxPrescaler;   /*!< Max timer prescaler */
	float Period;         /*!< Timer's working period */
	uint32_t Prescaler;      /*!< Timer's working prescaler */
	float Frequency;      	 /*!< Timer's reload frequency */
 ...
 * @retval Member of @ref TM_TIMER_PROPERTIES_Result_t
 */
TM_TIMER_PROPERTIES_Result_t TM_TIMER_PROPERTIES_GenerateDataForWorkingFrequency(TM_TIMER_PROPERTIES_t* Timer_Data, float frequency);
